...
# unlimited.
# ----------------------------------------------------------------------------
"""Unit tests for the padding methods in `gdm.Instrument`."""
...
class TestDataPaddingbyFile(object):
    """Unit tests for pandas `gdm.Instrument` with data padding by file."""
    ...
    def setup_method(self):
        ...
        self.testInst = gdm.Instrument(platform='gdm', name='testing',
                                       clean_level='clean', pad={'minutes': 5},
                                       update_files=True)
        self.testInst.bounds = ('2008-01-01.nofile', '2010-12-31.nofile')

        self.rawInst = gdm.Instrument(platform='gdm', name='testing',
...
class TestDataPaddingbyFileXarray(TestDataPaddingbyFile):
    """Unit tests for xarray `gdm.Instrument` with data padding by file."""
    ...
    def setup_method(self):
        ...
        self.rawInst = gdm.Instrument(platform='gdm', name='ndtesting',
                                      num_samples=86400, sample_rate='1s',
                                      clean_level='clean', update_files=True)
        self.rawInst.bounds = self.testInst.bounds
        self.delta = dt.timedelta(seconds=0)
...
class TestOffsetRightFileDataPaddingBasics(TestDataPaddingbyFile):
    """Unit tests for pandas `gdm.Instrument` with right offset data pad."""
...
class TestOffsetRightFileDataPaddingBasicsXarray(TestDataPaddingbyFile):
    """Unit tests for xarray `gdm.Instrument` with right offset data pad."""
...
class TestOffsetLeftFileDataPaddingBasics(TestDataPaddingbyFile):
    """Unit tests for pandas `gdm.Instrument` with left offset data pad."""
...
class TestDataPadding(object):
    """Unit tests for pandas `gdm.Instrument` with data padding."""
    ...
    def test_yrdoy_data_padding_missing_earlier_days(self):
        ...
        yr, doy = gdm.utils.time.getyrdoy(self.testInst.files.start_date)
    ...
    def test_yrdoy_data_padding_missing_later_days(self):
        ...
        yr, doy = gdm.utils.time.getyrdoy(self.testInst.files.stop_date)
        self.testInst.load(yr, doy, verifyPad=True)
        assert self.testInst.index[0] < self.testInst.date
        assert (self.testInst.index[-1]
                < self.testInst.date + dt.timedelta(days=1))
...
class TestDataPaddingNonMonotonic(TestDataPadding):
    """Unit tests for non-montonic pandas `gdm.Instrument` with data pad."""
...
class TestDataPaddingXArray(TestDataPadding):
    """Unit tests for xarray `gdm.Instrument` with data padding."""
...
class TestDataPaddingXArrayNonMonotonic(TestDataPadding):
    """Unit tests for non-montonic xarray `gdm.Instrument` with data pad."""
...
class TestMultiFileRightDataPaddingBasicsNonMonotonic(TestDataPadding):
    """Tests for non-monotonic pandas `gdm.Instrument` with right data pad."""
...
class TestMultiFileRightDataPaddingBasicsXarrayNonMonotonic(TestDataPadding):
    """Tests for non-monotonic xarray `gdm.Instrument` with right data pad."""
...
class TestMultiFileLeftDataPaddingBasicsNonMonotonic(TestDataPadding):
    """Tests for non-monotonic pandas `gdm.Instrument` with left data pad."""
...
class TestMultiFileLeftDataPaddingBasicsXarray(TestDataPadding):
    """Unit tests for xarray `gdm.Instrument` with left offset data pad."""
...
class TestMultiFileLeftDataPaddingBasicsXarrayNonMonotonic(TestDataPadding):
    """Tests for non-monotonic xarray `gdm.Instrument` with left data pad."""
