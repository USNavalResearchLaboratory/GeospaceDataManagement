...
# unlimited.
# ----------------------------------------------------------------------------
"""Tests the `gdm.utils.files` functions."""
...
import GeospaceDataManagement.instruments.methods.testing as pimtesting
...
class TestFileDirectoryTranslations(CICleanSetup):
    ...
    def test_updating_directories(self, capsys):
        ...
        gdm.params['directory_format'] = templ
...
class TestFileUtils(CICleanSetup):
    ...
    def setup_method(self):
        ...
        self.start = gdm.instruments.gdm_testing._test_dates['']['']
        ...
        gdm.utils.files.check_and_make_path(self.testInst.files.data_path)
        return
    ...
    def test_get_file_information(self):
        ...
        root_fname = ''.join(('gdm_testing_junk_{year:04d}_gold_',
    ...
    def test_check_and_make_path_exists(self, use_cwd):
        ...
        assert not gdm.utils.files.check_and_make_path(dir_name)
    ...
    def test_check_and_make_path_new(self, trailer):
        ...
        assert gdm.utils.files.check_and_make_path(new_dir)
    ...
    def test_check_and_make_path_expand_path(self):
        ...
        new_dir = os.path.join(home, 'gdm_check_path_testing')

        assert not os.path.isdir(new_dir)

        # Assert check_and_make_path creates the directory
        assert gdm.utils.files.check_and_make_path(new_dir, expand_path=True)
    ...
    def test_check_and_make_path_error(self, path):
        ...
        testing.eval_bad_input(gdm.utils.files.check_and_make_path,
