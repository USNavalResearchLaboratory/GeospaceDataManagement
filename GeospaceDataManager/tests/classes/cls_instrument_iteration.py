...
# unlimited.
# ----------------------------------------------------------------------------
"""Tests for iteration in the Instrument object and methods.
...
class InstIterationTests(object):
    """Basic tests for `gdm.Instrument` iteration methods.
    ...
    def support_iter_evaluations(self, starts, stops, step, width,
        ...
        starts = gdm.utils.listify(starts)
        stops = gdm.utils.listify(stops)
