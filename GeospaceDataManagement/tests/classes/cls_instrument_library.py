...
# unlimited.
# ----------------------------------------------------------------------------
"""Standardized class and functions to test instruments for libraries.

Notes
-----
Not directly called by pytest, but imported as part of test_instruments.py.
Can be imported directly for external instrument libraries of
GeospaceDataMangement instruments.
...
::
    ...
    from gdm.tests.classes.cls_instrument_library import InstLibTests
...
class InstLibTests(object):
    """Provide standardized tests for instrument libraries.
    ...
    See Also
    --------
    GeospaceDataManagement.tests.test_instruments
