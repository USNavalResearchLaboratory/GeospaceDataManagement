...
3. Create a branch for local development:
  ...
  ```
   ...
   Tests for new instruments are performed automatically.  See discussion in
   the docs `new_instrument.rst` for more information on triggering these
   standard tests.
...
7. Add your name to the CITATION.cff file as an author
...
3. Update the author list in ``CITAITON.cff``, if applicable
